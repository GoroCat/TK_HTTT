...
namespace Nhom4_QLST.Controllers
{
    public class SanPhamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSanPham,TenSanPham,MoTa,Gia,SoLuongTonKho,MaNhaCungCap")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSanPham,TenSanPham,MoTa,Gia,SoLuongTonKho,MaNhaCungCap")] SanPham sanPham)
        {
            if (ModelState.IsValid)
            {
